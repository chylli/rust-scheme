...
fn test_whitespace() {
    assert_eq!(tokenize("(+ 1 1)\n(+\n   2\t2 \n )\r\n \n").unwrap(),
               vec![TOpenParen, TIdentifier("+".to_string()), TInteger(1), TInteger(1), TCloseParen, TOpenParen, TIdentifier("+".to_string()), TInteger(2), TInteger(2), TCloseParen]);
}
